# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-22 08:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('configfactory', '0010_remove_component_schema'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fallback', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='environments', to='configfactory.Environment', verbose_name='fallback environment')),
            ],
            options={
                'ordering': ('order', 'name'),
